/* Lesson 034
  	In accordance with the Washington Naval Treaty concluded in the beginning of 1922, it was prohibited to build battle ships with a displacement 
  	of more than 35 thousand tons. 
...
where s1.launched is not null and s1.launched>=1922 and c1.displacement>35000 and c1.type='bb'
